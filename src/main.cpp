...
int main(int argc, char* argv[]) {
    ...
    string in_filename = "C:/Users/haoya/Downloads/fusion-ukf-master/data/data-3.txt";
    string out_filename = "C:/Users/haoya/Downloads/fusion-ukf-master/data/out-3.txt";
